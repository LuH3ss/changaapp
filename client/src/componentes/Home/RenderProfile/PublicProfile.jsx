...
export default function PublicProfile() {
  ...
  return (
    <Box sx={{ backgroundColor: "#E5E7EB" }}>
      <Navbar />
      <Button
        sx={{ margin: "2% 0 0 4%", backgroundColor: "#1F2937" }}
        variant="contained"
        ...
        >
          ...
          >
            ...
            >
              <Typography
                sx={{ fontSize: "1.5rem" }}
              >{`${filterUser[0]?.firstName} ${filterUser[0]?.lastName}`}</Typography>
              <Typography sx={{ fontSize: "1rem" }}>
                {filterUser[0]?.description}
              </Typography>
              <Typography
                sx={{
                  fontSize: "1.2rem",
          ...
          >
            {filterUser[0]?.reviews?.length === 0 ? (
              <Typography>Sin reseñas por el momento </Typography>
            ) : (
            ...
            <Dialog style={{ padding: "0" }} open={btn}>
              ...
              >
                ...
                >
                  <span style={{ width: "30px" }} onClick={handleOpen}>
                    <CloseIcon />
                  </span>
                </Box>
