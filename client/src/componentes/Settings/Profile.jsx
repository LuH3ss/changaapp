...
export default function Profile() {
  ...
  if(loading) return <Box sx={{width:'70%'}}>
    <h1>Loading..</h1>
    </Box>
        ...
        
        {
          ...
          :  
            (
              ...
              //   </CardContent> 
              // </Card>
              <Box variant='section' className="profile-container" sx={{width:'100%', padding: '10%'}}>
    ...
    width: '300px'}}>
                  ...
                  <Box sx={{display: 'flex', alignItems: 'baseline', gap:'20px' }} variant='div'>
                    <Typography variant="h6">
                      Nombre y Apellido 
                    </Typography>
                    <Typography variant="h6">{estado[0].firstName + ' ' + estado[0].lastName}</Typography>
                  </Box>
                  <Box sx={{display: 'flex', alignItems: 'baseline', gap:'80px' }} variant='div'>
                    <Typography variant="h6">
                      Descripción 
                    </Typography>
                    <Typography variant="h6">
